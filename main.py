...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Record stereo WAV files for each direction and paired direction using sounddevice."
        )
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=int,
        default=0,
        help="Optional blocksize passed to sounddevice (0 lets PortAudio decide).",
    )
    parser.add_argument(
        "--device",
        type=str,
